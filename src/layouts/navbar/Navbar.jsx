...
const Navbar = () => {
  ...
  return (
    <nav className="navbar">
      <div className="navbar-container">
        <div className="navbar-row">
          ...
          <div className="nav-menu-desktop">
            ...
            <Link to="/contact" className="nav-btn text-decoration-none">
              {t('registerBtn')}
            </Link>
          </div>
      ...
      {/* Mobil Menyu — "Natijalar" muvaffaqiyatli qo'shildi */}
      {isOpen && (
        <div className="nav-menu-mobile">
          ...
          <NavLink to="/results" onClick={() => setIsOpen(false)} className="nav-link">{t('results')}</NavLink> {/* 🔥 Yangi havola */}
          ...
          <Link to="/contact" onClick={() => setIsOpen(false)} className="nav-btn nav-btn-mobile text-decoration-none">
            {t('registerBtn')}
          </Link>
        </div>
      )}
